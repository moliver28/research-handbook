...
1. After gaining Legal approval, PS Quote triggers an Epic in Gitlab.com around the recently sold Professional Services Project, at the Professional Services Group level. This _Customer Epic_ is labeled as SOW# + Customer and includes links to relevant Customer & contract information
...
4. Once the EM checklist is complete & confirmed by the Delivery team in the scheduling intake issue, the PM can begin setting up the Project within Gitlab.com, setup Project folders, and create the internal Slack channel
   1. Find and rename the _Project Retrospective" issue and follow the steps outlined in the [Project Retrosoective template](https://gitlab.com/gitlab-com/customer-success/professional-services-group/ww-consulting/ps-plan/-/blob/master/.gitlab/issue_templates/project_retrospective.md?ref_type=heads) 
   ...
   2. Create Project in Gitlab.com using CPR (Customer Project requirements) *new steps to CPR coming soon* 
...
6. PMs then schedule and conduct the EM>PS Transition Meeting with the Technical Delivery team- the goal is to ultimately review this out of Gitlab
7. PMs to conduct the [Stakeholder Introduction](https://docs.google.com/document/d/1fOmBxXf9MqYHQ8LZD5nIepu5WcFeTiwss59RJbd3BWE/edit?usp=sharing) Meeting & prepare for Kickoff 
8. Create an external Slack channel to collaborate with the customer and add a link to it to the kick-off deck. [AR example](https://gitlab.com/gitlab-com/team-member-epics/access-requests/-/issues/24542)
9. PMs to conduct the [Initial Customer Kickoff](https://docs.google.com/presentation/d/1XUljBcQUZgQA-0fhQ5UayiEGtp4Of3xsaFGpVxdoDS4/edit?usp=sharing) 
10. The PM to ensure the communiation plan, delivery methodology, scope definitions, time, and budget are aligned as we head into Delivery

11. Consulting Blocks and Dedicated Engineer Projects
...
*Billable vs NonBillable information*, please refer to [Team Metrics](https://handbook.gitlab.com/handbook/customer-success/professional-services-engineering/#team-metrics) page 
...
*Time & Materials (T&M) vs Fixed Fee (Fixed Fee)*
*defintions to be added* 
