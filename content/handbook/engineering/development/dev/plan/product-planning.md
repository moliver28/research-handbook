...
{{% stable-counterparts manager-role="Engineering Manager(.)Plan:Product Planning" role="(.)Plan:Product Planning$|Product Manager(.)Plan Stage|Security(.)Plan|Engineering(.)Plan$|Principal(.)Plan$|Group(.*)Plan" %}}
