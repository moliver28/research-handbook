...
We use of sub-tasks in issues to help with refinement. The goal is that we have one SSOT issue that contains threaded discussions around all aspects of the team, including backend, frontend, UX, Product, and documentation
