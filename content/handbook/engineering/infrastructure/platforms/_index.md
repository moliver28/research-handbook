...
The SaaS Platforms group is slowly migrating requests for help to go through the [#saas-platforms-help](https://gitlab.enterprise.slack.com/archives/C07DU5Z7V6V) channel which redirects team-members to please engage with the [landing page for getting assistance](./getting-assistance). The purpose is to try to connect team members directly with the SaaS Platforms team that can help with their request rather than answering all questions directly in the channel itself.
