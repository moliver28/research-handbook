...
| ![Ongoing](img/label-ongoing.png) | This is generally applied to epics that have ongoing work. For example tracking team meta work, or "keeping the lights on" work for a given year. There is not distict exit criteria and the epic or issue may be timeboxed or be replaced by a new epic for the next time period. |
