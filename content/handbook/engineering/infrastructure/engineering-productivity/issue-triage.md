...
| {{< label name="priority::2" color="#ff8800" >}} | High       | We will address this soon and will provide capacity from our team for it in the next few releases. This will likely get resolved in 60-90 days. | PM, EM, or QEM of that product group, based on work type |
| {{< label name="priority::3" color="#fff600" dark="true" >}} | Medium     | We want to address this but may have other higher priority items. This will likely get resolved in 90-120 days.                                 | PM, EM, or QEM of that product group, based on work type |
...
The presence of bug category labels {{< label name="bug::availability" color="#cc0000" >}}, {{< label name="bug::performance" color="#cc0000" >}}, {{< label name="bug::vulnerability" color="#cc0000" >}}, and {{< label name="UX" color="#d10069" >}} denotes to use the severity definition in that category. When a {{< label name="type::bug" color="#cc0000" >}} correspond to multiple categories, the severity to apply should be the higher, for example, if an issue has a {{< label name="severity::2" color="#ff8800" >}} for {{< label name="bug::availability" color="#cc0000" >}} and a {{< label name="severity::1" color="#cc0000" >}} for {{< label name="bug::performance" color="#cc0000" >}} then the severity assigned to the issue should be {{< label name="severity::1" color="#cc0000" >}}.
...
| Type of {{< label name="type::bug" color="#cc0000" >}}                                                         | {{< label name="severity::1" color="#cc0000" >}}: Blocker                                                                                                                                           | {{< label name="severity::2" color="#ff8800" >}}: Critical                                                                                                                                          | {{< label name="severity::3" color="#fff600" dark="true" >}}: Major                                                                                                                                                | {{< label name="severity::4" color="#008000" >}}: Low                                                                                                                                               | Triage DRI                                                                                                                                                                               |
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| {{< label name="severity::2" color="#ff8800" >}} | 30 days                                               | The next release (60 days)                                                     |                                                    | See [Vulnerability Remediation SLAs](/handbook/security/threat-management/vulnerability-management/#remediation-slas) |
| {{< label name="severity::3" color="#fff600" dark="true" >}} | 60 days                                               | Within the next 3 releases (approx one quarter or 90 days)                     |                                                    | See [Vulnerability Remediation SLAs](/handbook/security/threat-management/vulnerability-management/#remediation-slas) |
...
-   Example(s) of {{< label name="severity::2" color="#ff8800" >}}
...
-   Example(s) of {{< label name="severity::3" color="#fff600" dark="true" >}}
...
Issues with {{< label name="bug::availability" color="#cc0000" >}} label directly impacts the availability of GitLab.com SaaS. It is considered as another category of `~"type::bug"`.
...
The presence of these severity labels modifies the standard severity labels({{< label name="severity::1" color="#cc0000" >}}, {{< label name="severity::2" color="#ff8800" >}}, {{< label name="severity::3" color="#fff600" dark="true" >}}, {{< label name="severity::4" color="#008000" >}}) by primarily taking into account the impact to users. The severity of these issues may change depending on the re-analysis of the impact to GitLab.com users.
...
| {{< label name="severity::2" color="#ff8800" >}} | Problem on GitLab.com blocking the typical user's workflow<br/><br/>Impacts 20% or more of users, but a reasonable workaround is available.<br/><br/>Impacts between 5%-20% of users without an available workaround                                                                                                                                                                | Within 24 hrs             | Within 7 days            | {{< label name="priority::1" color="#cc0000" >}} |
| {{< label name="severity::3" color="#fff600" dark="true" >}} | Broad impact on GitLab.com and minor inconvenience to typical user's workflow. No workaround needed.<br/><br/>Impacts up to 5% of users                                                                                                                                                                                                                                             | Within 72 hrs             | Within 30 days           | {{< label name="priority::2" color="#ff8800" >}} |
| {{< label name="severity::4" color="#008000" >}} | Minimal impact on GitLab.com typical user's workflow to less than 5% of users <br/><br/>May also include incidents with no impact, but with importance to resolve to prevent future risk                                                                                                                                                                                            | Within 7 days             | Within 60 days           | {{< label name="priority::3" color="#fff600" dark="true" >}} |
...
| --------------------------------------- | --------------------------------------------------------------------------- | -------------------------------------------------------- |
| {{< label name="bug::availability" color="#cc0000" >}} {{< label name="severity::1" color="#cc0000" >}} | {{< label name="priority::1" color="#cc0000" >}} only                                                       | {{< label name="priority::2" color="#ff8800" >}}, {{< label name="priority::3" color="#fff600" dark="true" >}}, and {{< label name="priority::3" color="#008000" >}} |
| {{< label name="bug::availability" color="#cc0000" >}} {{< label name="severity::2" color="#ff8800" >}} | {{< label name="priority::1" color="#cc0000" >}} only                                                       | {{< label name="priority::2" color="#ff8800" >}}, {{< label name="priority::3" color="#fff600" dark="true" >}}, and {{< label name="priority::3" color="#008000" >}} |
| {{< label name="bug::availability" color="#cc0000" >}} {{< label name="severity::3" color="#fff600" dark="true" >}} | {{< label name="priority::2" color="#ff8800" >}} as baseline, {{< label name="priority::1" color="#cc0000" >}} allowed                      | {{< label name="priority::3" color="#fff600" dark="true" >}}, and {{< label name="priority::3" color="#008000" >}}                   |
| {{< label name="bug::availability" color="#cc0000" >}} {{< label name="severity::4" color="#008000" >}} | {{< label name="priority::3" color="#fff600" dark="true" >}} as baseline, {{< label name="priority::2" color="#ff8800" >}} and {{< label name="priority::1" color="#cc0000" >}} allowed | {{< label name="priority::3" color="#008000" >}}                                         |
...
| ------------------ | -------------------------------------------------------- | ------------------------------------------------------- |
| {{< label name="severity::1" color="#cc0000" >}}   | {{< label name="priority::1" color="#cc0000" >}} only                                    | {{< label name="priority::2" color="#ff8800" >}}, {{< label name="priority::3" color="#fff600" dark="true" >}} and {{< label name="priority::3" color="#008000" >}} |
| {{< label name="severity::2" color="#ff8800" >}}   | {{< label name="priority::1" color="#cc0000" >}} only                                    | {{< label name="priority::2" color="#ff8800" >}}, {{< label name="priority::3" color="#fff600" dark="true" >}} and {{< label name="priority::3" color="#008000" >}} |
| {{< label name="severity::3" color="#fff600" dark="true" >}}   | {{< label name="priority::1" color="#cc0000" >}} or {{< label name="priority::2" color="#ff8800" >}}                     | {{< label name="priority::3" color="#fff600" dark="true" >}} and {{< label name="priority::3" color="#008000" >}}                   |
| {{< label name="severity::4" color="#008000" >}}   | {{< label name="priority::1" color="#cc0000" >}} or {{< label name="priority::2" color="#ff8800" >}} or {{< label name="priority::3" color="#fff600" dark="true" >}} | {{< label name="priority::3" color="#008000" >}}                                        |
...
| ------------------------- | ---------------- | ------------------------------------------------------ | ------------------------------------------------------- |
| Smoke end-to-end test     | {{< label name="severity::1" color="#cc0000" >}} | {{< label name="priority::1" color="#cc0000" >}} only                                  | {{< label name="priority::2" color="#ff8800" >}}, {{< label name="priority::3" color="#fff600" dark="true" >}} and {{< label name="priority::3" color="#008000" >}} |
| Non-smoke end-to-end test | {{< label name="severity::2" color="#ff8800" >}} | {{< label name="priority::2" color="#ff8800" >}} as baseline, {{< label name="priority::1" color="#cc0000" >}} allowed | {{< label name="priority::3" color="#fff600" dark="true" >}} and {{< label name="priority::3" color="#008000" >}}                   |
...
GitLab, like most large applications, enforces limits within certain features. The absences of limits can impact security, performance, and availability. For this reason issues related to limits are considered `~"type::bug"` in the {{< label name="bug::availability" color="#cc0000" >}} sub-category.

In order to define an issue as related to limits add the labels `~"availability::limit"` and {{< label name="bug::availability" color="#cc0000" >}}.
...
| {{< label name="severity::2" color="#ff8800" >}} | Absence of this limit poses a risk to reduced availability of GitLab                                |
| {{< label name="severity::3" color="#fff600" dark="true" >}} | Absence of this limit has a negative impact on ability to manage cost, performance, or availability |
