...
1. [Activate Development On-Call](https://handbook.gitlab.com/handbook/engineering/on-call/#development-team-on-call-rotation). While it may seem unnecessary, many backend developers are familiar enough with the application and database that they should be able to help isolate a source while trying to get database experts involved.
...
1. [Activate Development On-Call](https://handbook.gitlab.com/handbook/engineering/on-call/#development-team-on-call-rotation)
