...
- [001: Compliance Adherence Checks](decisions/001_compliance_adherence_checks.md)
- [002: Custom Adherence Report](decisions/002_custom_adherence_report.md)

### Design Details

We decided to use [Sidekiq workers for creating checks](decisions/001_compliance_adherence_checks.md#use-sidekiq-workers-for-creating-and-updating-checks)
