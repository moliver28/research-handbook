...
Patch releases have multiple touchpoints between many teams to prepare, validate and release fixes. 
...
The patch release includes all bug and security fixes ready at the time of release preparation. Security fixes are worked on in the mirrored GitLab security repositories to avoid revealing vulnerabilities before the release.
