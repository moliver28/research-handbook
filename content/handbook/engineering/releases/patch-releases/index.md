...
1. Planned (default): A planned patch release to publish all available bug and vulnerability fixes per [the maintenance policy](https://docs.gitlab.com/ee/policy/maintenance.html). This is an SLO driven type that take place around the [monthly release](https://about.gitlab.com/releases/).
...
![Planned security release overview](patch_release_overview.png)
...
Following our [maintenance policy], the vulnerability will be
...
![Unplanned critical security release overview](unplanned_patch_release_overview.png)
