...
- **Scenario 2:** If your survey requires a larger sample, you may run the risk of oversampling companies with more GitLab licenses (i.e., large enterprises)
     - Why? Based on the results of our survey, we want to be able to say that our survey sample is representative of our larger population. If a large portion (at least 10%) of our sample is made up of users from a few different companies, we have less confidence in our results because they are more representative of those few companies compared to our larger user base.
     - When trying to maintain the balance between accuracy and sampling, we recommmend contacting **up to 10 users** from a single company within your survey. That way, even if responses from a given company exceed the average response rates of 2-3%, your results are less likely to be influenced by groups of users.
- **Scenario 3:** If your research is trying to understand how many people are doing a certain workflow, or how people would rank certain features, you probably don’t need as many people to sample as the above Scenario 1. Example: survey to understand how users are ranking features (n=30)
