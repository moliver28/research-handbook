...
- **Scenario 2:** If your survey requires a larger sample, you may run the risk of oversampling companies with more GitLab licenses (i.e., large enterprises). Example: CSAT (n=400)
     - Why? Based on the results of our survey, we want to be able to say that our survey sample is representative of our larger population. If a **large portion (at least 10%) of our sample** is made up of respondents from a few different companies, we have less confidence in our results because they are more representative of those few companies compared to our larger user base.
