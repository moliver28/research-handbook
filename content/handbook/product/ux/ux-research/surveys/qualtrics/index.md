...
1. Select `Embedded data`, select an `Embedded Data field`, select an `Operator` and enter/select an `Embedded Data Value`.
    ...
    - For more information on what embedded data is available, please refer to the [embedded data](/handbook/product/ux/ux-research/qualtrics/#embedded-data) section.
...
1. The number of contacts in your sample will show on the left hand side of the screen.
    - [What to do if your sample size is lower than expected](/handbook/product/ux/ux-research/qualtrics/#what-to-do-if-your-sample-size-is-lower-than-expected)
