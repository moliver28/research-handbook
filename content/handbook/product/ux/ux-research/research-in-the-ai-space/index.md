...
While outside the scope of UX research, a good step is always to validate that the problem can be solved with AI. The PM and EM can help with this, by testing potential prompts against existing models and data sets to see what quality of answer comes out. If the underlying data/models don't support high quality answers, then it might not be the right problem to solve with AI just yet.
...
Did you know that you can validate your future AI powered capability in parallel to the engineering team building it by using [Wizard of Oz prototyping](https://medium.com/@lizschemanski/wizard-of-oz-experiments-eed2c0a12081)? Validating before the AI solution is available is a great way to capture users' expectations and requirements early on. They can inform engineering efforts in training the AI.
...
It may be tempting, but don’t ask users if they would use this AI capability. People are poor predictors of future behavior, so their answers won’t be accurate or useful for you. To get closer to understanding if people may use a solution, it’s best to understand:
...
We are piloting a [set of AI metrics](#ai-user-experience-metrics-pilot) that allow you to evaluate and track user's experience with AI powered capabilities over time.

## AI User Experience Metrics (Pilot)

We developed, and are currently piloting, a set of metrics to evaluate AI powered capabilites in terms of how well they are meeting user needs. These metrics can be used during Solution Validation and to track a user's experience with an AI powered capability over time.
...
- **Value:** Are we helping users to be faster and more productive? Are we helping users to learn new things? Do users perceive a benefit from using the AI powered capability?
...
- **Learnability:** Are users able to quickly understand the AI powered capability?
- **AI limits:** Do users feel like they understand what the AI powered capability can and can't do?

A survey with these metrics is available for you to send to your participants who are working with AI capabilities. If you want to use this survey, ask Anne Lasch for access to the Qualtrics project.
