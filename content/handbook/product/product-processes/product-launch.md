...
### Summary of phases
1. NPI planning: teams & a SteerCo define scope and requirements; agree on prioritization of NPI project against other priorities
...
1. It represents a significant enough financial or strategy opportunity to warrant investment of dozens of teams’ effort
...
1. **What** we’re launching: product features & functionality, or service entitlements
...
1. **Who** we’re targeting: ICP and target market
1. **When** we need to launch: any internal or external factors that create timing requirements
...
We are actively iterating on the NPI process. You can follow along with our work in the #npi-process-working-group slack channel. Since this is an active change to ongoing processes, we've left the original process instructions at the bottom of this page. This section will be removed once the revised NPI process is finalized. 

If you have feedback about the NPI process, please reach out in the #npi-process-working-group slack channel.
...
**The Program Manager** coordinates and directs the multiple parallel work streams required by the NPI process. The Program Manager can be assigned from the Product division, or if necessary from the Chief of Staff team. The Professional Services team can program manage SKU additions or modifications for professional services. In some cases, the DRI and the Program Manager may be the same person.
...
1. Contact Sean Hall or Justin Farris to schedule time with the Pricing Committee
...
### Step 3: Meet with the NPI Steer-Co and get alignment on the launch plan
...
The NPI Steer-Co will advise on whether there are available resources to complete the NPI process for your proposed feature or service. In some cases, there may not be sufficient resources to match the prioritization level of a given project. In that case, it is important for the Business Sponsor and the NPI Steer-Co to work together to escalate to the exec team for further direction.

### Step 4: Communicate the plan to stakeholders

Once the NPI Steer-Co has given your project the go-ahead, it’s time to get the rest of the stakeholders aligned. Reminder: there are many steps required to deliver a net new SKU; this isn't a process for processes-sake. We’ve learned through multiple NPI projects that this kind of work can’t be completed efficiently without clear communication and transparency.
...
The Program Manager should ensure that the team is set up for success. The following resources are valuable, but not mandatory. We recommend creating a SSOT with a link out to the following resources / information.
...
<strong> Summary of the steps.</strong>
...
<strong> Step 1) Business Sponsor /  program manager should be assigned to launch the product/service or SKU. </strong>
...
<strong> Step 2) The product or service needs to be clearly defined </strong>
...
<strong> Step 3) Pricing research / pricing and packaging plan should be created </strong>
...
<strong> Step 4) A Operations/ business plan / financial projection should be developed for the product / service </strong>
...
<strong> Step 5) Approvals should be obtained to move forward with the launch </strong>
...
<strong> Step 6) Product Launch checklist should be created with clear DRIs assigned </strong>
...
<strong> Step 7) Execution against Product Launch checklist should happen </strong>
