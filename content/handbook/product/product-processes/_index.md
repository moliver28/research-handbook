...
This process should be both up front and on an on-going basis when building features. We [use GitLab to power our product development flow](/handbook/product/product-processes/planning-with-gitlab). 
