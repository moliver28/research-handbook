...
To ensure that our efforts consistently deliver value to our users each iteration must adhere to the following guidelines:
  ...
  1. Define Expected Impact: Clearly articulate the expected measurable positive impact of the iteration on users, ensuring alignment with our overall product direction and guided  by a preferred vision that has been informed by user research
