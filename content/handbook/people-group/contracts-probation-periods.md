...
GitLab will take all neccessary steps to ensure background screenings are completed before a candidate's start date and may adjust a candidate's start date to satisfy this requirement. Circumstances beyond GitLab's control may serve as exceptions to this requirement such as exigent circumstances that affect access to background information such as natural disasters, public emergencies, signifincant outages, candidate hardship, and other potentially unforseen circumstances that may serve as an exception. All exceptions will be reviewed on an individual basis. GitLab will ensure each background screening is completed and satisfactory should a candidate need to onboard before their background screening has completed due any exception.
