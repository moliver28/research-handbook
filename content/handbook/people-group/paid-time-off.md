...
1. As of 2022-05-01, we've created a Flexible PTO policy to better outline communication expectations for team members and managers. This means that:
    ...
    - We care about results, not how long you work, but PTO should not come at the expense of on-time deliverables--unless trade-offs are well known and agreed upon. GitLab team members do not work in a vacuum. Beyond the direct team member goals, we need to be aware of how absences impact other team members' abilities to achieve results. We require managers to ensure that appropriate coverage is in place for their team. This requires managers to assess all PTO against team deliverables.
    ...
    - It can be helpful to take longer breaks to re-energize. Each team member is different, so they should evaluate how best to utilize their time away. Some people may choose to take vacation in a two week block. Others may prefer a more regular day away. 
...
1. People shouldn't boast about not taking time off. Not taking time off could be a symptom of not fostering collaboration in training others in your job and not being able to document and explain your work. You are doing the company a disservice by being a single point of failure. The company should be able to go for long periods without you. We don't want to lose you permanently by you burning yourself out by not taking regular time off.
...
1. GitLab encourages team members to volunteer within their community. Consider taking time in support of causes that matter to you and support your personal commitment to GitLab's values such as diversity, inclusion and belonging.
...
1. GitLab also encourages you to take time off to vote or volunteer at the polls.
...
1. As outlined above, it's expected that you provide your manager and team members who may expect to work with you with as much advanced notice as possible about your planned time off. You should give other team members advanced notice that is at least as many weeks as the time that you plan to take off. For example, if you plan to take 3 days off, you should let other team members know **at least** 3 weeks before.
...
1. Pull a report of PTO taken in the previous quarter(s)
