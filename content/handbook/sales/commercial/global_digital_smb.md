...
- A. No, update the Next Steps stating that the customer is open to conversation in 6 months.  Also change the Next Steps Date to 6 month from todays date, and update the stage of the case to TBD.  Finaly click the Edit buton on the case, and check the *Asign using active assignment rules*. The case will subsequently drop back into the queue in 6 months time. 
