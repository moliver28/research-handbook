...
|----------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SAOs/Stage 1 ARR                       | - Informal performance management begins when an XDR has two consecutive months below 80% attainment                                                                          |
...
| Stage 3 ARR                       | - Informal performance management begins when a BDR has two consecutive months below 80% Stage 3 attainment                                                                          |
