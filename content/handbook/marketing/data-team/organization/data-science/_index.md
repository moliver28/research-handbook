...
[Become a Data Science Champion](/handbook/marketing/data-team/direction/data-champion/), [visit Slack #bt-data-science](https://gitlab.slack.com/archives/C027285JQ4E), [watch a Data Team video](https://www.youtube.com/playlist?list=PL05JrBw4t0KrRVTZY33WEHv8SjlA_-keI). We want to hear from you!
{{% /alert %}}
...
Of the [Data Team's Responsibilities](/handbook/marketing/data-team/#responsibilities), the Data Science Team is **directly responsible** for:
...
- With the [**Data Platform Team**](/handbook/marketing/data-team/organization/engineering/):
...
- With the [**Data Analytics Team**](/handbook/marketing/data-team/organization/analytics/):
...
The [Data Science Team approach to model development](/handbook/marketing/data-team/organization/data-science/project_dev_approach/) is centered around GitLab's value of [iteration](/handbook/values/#iteration) and the CRISP-DM standard. Our process expands on some of the 6 phrase outlined in CRISP-DM in order to best address the needs of our specific business objectives and data infrastructure.

## Data Science Platform

Our current platform consists of:

- the [Enterprise Data Warehouse](/handbook/marketing/data-team/platform/) for storing raw and normalized source data as well as final model output for consumption by downstream consumers
- [JupyterLab](/handbook/marketing/data-team/platform/jupyter-guide/) for model training, tuning, and selection
...
-[GitLab CI](/handbook/marketing/data-team/platform/ci-for-ds-pipelines/#our-approach-to-using-cicd-for-data-science) for automation and orchestration
...
1. How to use [Feast to fetch features to train and deploy Machine Learning models](/handbook/marketing/data-team/platform/feast/).
...
We are in the process of fully moving over the training and scoring of our machine learning models to the native GitLab CI/CD capabilities. Please see [Getting Started With CI/CD for Data Science Pipelines](/handbook/marketing/data-team/platform/ci-for-ds-pipelines/) for the most up-to-date information and instructions.

### Data Science Tools at GitLab

- **[Pre-configured JuypterLab Image](https://gitlab.com/gitlab-data/data-science)**: The data science team uses JupyterLab pre-configured with common python modules (pandas, numpy, etc.), native Snowflake connectivity, and git support. Working from a common framework allows us to create models and derive insights faster. This setup is freely available for anyone to use. Check out our [Jupyter Guide](/handbook/marketing/data-team/platform/jupyter-guide/) for additional information.
