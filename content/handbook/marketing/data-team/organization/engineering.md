...
The mission of the Data Platform team is to build a secure and trusted data platform that makes it possible for **everyone to be an analyst** so that our *only* limitations are the data or analysts themselves. We do this **by means of our [GitLab values](/handbook/values/)** and our **[Data Team Principles](/handbook/marketing/data-team/#data-team-principles)**

## Data Platform Responsibilities

Of the [Data Team's Responsibilities](/handbook/marketing/data-team/#responsibilities) the Data Platform team is directly responsible for:

- Integrating new data sources to enable analysis of subject areas, activities, and processes
- Keeping the data sources running per established [Service Level Objectives and Tiers](/handbook/marketing/data-team/platform/#data-sources)
