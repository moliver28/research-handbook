...
Engineers are expected to complete 12+ weight points iteration, which includes time for reviewing merge requests, attending meetings, and fulfilling other duties as part of the Digital Experience team. For senior engineers, the expectation is 15+ points. This guideline is not a strict requirement since issue weights and work scope can vary due to the dynamic nature of marketing. However, it's helpful to document this guideline transparently.
