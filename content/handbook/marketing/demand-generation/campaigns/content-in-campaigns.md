...
### Types of content in campaigns {#content-types} <!-- DO NOT CHANGE THIS ANCHOR -->
...
## How to pick content for campaigns {#picking-content-for-campaigns} <!-- DO NOT CHANGE THIS ANCHOR -->
...
## Internally-Created Content (i.e. eBooks, Guides) {#internal-content} <!-- DO NOT CHANGE THIS ANCHOR -->
...
### Epic code and issues - Internal GitLab Content {#epic-issues-internal-content} <!-- DO NOT CHANGE THIS ANCHOR -->
...
## Externally-Created Content (i.e. Analyst Relations) {#external-content} <!-- DO NOT CHANGE THIS ANCHOR -->
...
### Epic code and issues - External Content {#epic-issues-external-content} <!-- DO NOT CHANGE THIS ANCHOR -->
...
## Adding new content to the Resources page {#add-to-resources-page} <!-- DO NOT CHANGE THIS ANCHOR -->
...
## How to extend analyst assets {#extend-analyst-assets} <!-- DO NOT CHANGE THIS ANCHOR -->
...
## How to retire analyst assets when they expire {#retire-analyst-assets} <!-- DO NOT CHANGE THIS ANCHOR -->
...
### Retire Marketo landing page {#retire-marketo-page} <!-- DO NOT CHANGE THIS ANCHOR -->
...
### Remove from Intelligent Nurture {#remove-intelligent-nurture} <!-- DO NOT CHANGE THIS ANCHOR -->

Please follow the process outlined in the [Emails/Nurture Handbook](/handbook/marketing/lifecycle-marketing/emails-nurture).

### Remove from Pathfactory {#remove-pathfactory} <!-- DO NOT CHANGE THIS ANCHOR -->
...
### Marketo automation and setup for gated landing page {#steps-gated-landing-pages} <!-- DO NOT CHANGE THIS ANCHOR -->
...
#### Create Marketo program, tokens, and SFDC campaign sync {#steps-gated-mkto-sfdc} <!-- DO NOT CHANGE THIS ANCHOR -->
...
#### Edit registration page and thank you page URLs {#steps-gated-registration-page} <!-- DO NOT CHANGE THIS ANCHOR -->
...
#### Edit "resulting page" from the form submit {#steps-gated-resulting-page} <!-- DO NOT CHANGE THIS ANCHOR -->
...
#### Activate smart campaign(s) {#steps-gated-activate-smart-campaigns} <!-- DO NOT CHANGE THIS ANCHOR -->
...
#### Update SFDC campaign {#steps-gated-update-sfdc} <!-- DO NOT CHANGE THIS ANCHOR -->
...
#### Test live registration page and flows {#steps-gated-testing} <!-- DO NOT CHANGE THIS ANCHOR -->
...
## Potential backup process {#retire-marketo-page} <!-- DO NOT CHANGE THIS ANCHOR -->
