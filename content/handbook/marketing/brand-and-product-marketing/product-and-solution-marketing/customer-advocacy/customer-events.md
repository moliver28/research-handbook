...
### Requesting a customer for a webinar
   ...
   9. If customer accepts, introduction to the marketing manager is coordinated.
   10. If customer outreach is unsuccessful (max 2 customers approached), the Event Manager can look at internal alternatives and takes their event forward without further CRM involvement.
   11. When the customer agrees to present; the Marketing manager should open an SM Request issue for content support with the PMM team.
...
### Requesting a customer for Public Relations activities
 ...
 5. CRM will introduce the PR Manager to the customer to liaise with them on the PR activity.
 6. CRM will update ReferenceEdge post the PR activity.
