...
- [Customer Case Studies](https://about.gitlab.com/customers/) - on the the GitLab website
...
> **Know of a customer that could be a reference?** The best route for securing references (of any kind, including earnings) is by working it into our contracts and/or order forms, which gives us legal pre-approval for the reference and eliminates risk. Section 8.6 of the standard MSA grants us the right to use the customer as a reference; if this section is at risk of removal or redlining, please work with our Legal and Customer Advocacy teams to create a modified reference agreement.
...
### **Customer-Facing Advocacy Program (Base)**
