...
For AI features with autonomous capabilities, we should also aim to:

- Implement strong safeguards to protect user data and systems;
- Place appropriate limits on agent autonomy and capabilities;
...
For AI features with autonomous capabilities, we should additionally:

- Define clear boundaries for agent actions;
- Enable user intervention at critical points in the workflow;
...
For AI features with autonomous capabilities, we should strive to:

- Provide clear information on agent actions and decision-making processes;
- Allow users to approve, modify, or cancel workflows when appropriate, recognizing that we can't guarantee user consent in every case.
...
These principles are intended as guidelines to bear in mind during the development process, not as explicit commitments or guarantees. We remain committed to responsible AI development that aligns with our CREDIT values and welcomes feedback from our community.