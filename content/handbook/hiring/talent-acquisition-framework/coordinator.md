...
The People Connect team has an SLA period of 10 working days to onboard an entity-based team member. In the event of an exception, the minimum notice required for the People Connect team is 5 working days. The People Connect team requires a minimum of 10 working days to successfully onboard a new team member from a PEO. While generating the PEO contract, it's important to ensure the PEO payroll cut-off date is also factored in. The non-US payroll cut off dates can be found [here](https://internal.gitlab.com/handbook/finance/payroll/#payroll-cut-off)
