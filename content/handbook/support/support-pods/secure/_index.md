...
- Leads: {{< member-by-name "Katrin Leinweber" >}} (`@katrinleinweber`), {{< member-by-name "Brie Carranza" >}} (`@bcarranza`)
...
1. Submit a merge request to add `'Support Focus: Secure'` to your ZenDesk Groups in [`support-team.yaml`](https://gitlab.com/gitlab-com/support/team/-/blob/master/data/support-team.yaml).
