...
[Pairify](https://gitlab.com/gitlab-com/support/toolbox/pairify) is a Slack bot application that will scan a Slack channel on a schedule for any conversations reacted with ![Pairify emoji](https://handbook.gitlab.com/support/workflows/assets/pairify.png "Pairify emoji") (`:pairify:`).
...
![Pairify demo](https://handbook.gitlab.com/support/workflows/assets/pairify_demo.gif)
...
1. React to the thread in the [`#spt_pairing`](https://gitlab.enterprise.slack.com/archives/C03UW0HPBGD) channel with the ![Pairify emoji](https://handbook.gitlab.com/support/workflows/assets/pairify.png "Pairify emoji") (`:pairify:`) emoji to mark a conversation for Pairify to process.
...
1. React to the conversation with an ![Issue created emoji](https://handbook.gitlab.com/support/workflows/assets/pairify_issue-created.png "Issue created emoji") (`:issue-created:`) emoji so the conversation is not processed again on subsequent executions.
...
|-----------------------------------------------------------------------------------------------------------|------------------|------------------------------------------------------|
| ![Baobab emoji](https://handbook.gitlab.com/support/workflows/assets/pairify_baobab.png "Baobab emoji")                    | `:baobab:`       | Adds the `SGG::Baobab` label to the pairing issue     |
| ![Ginkgo emoji](https://handbook.gitlab.com/support/workflows/assets/pairify_ginkgoleaf.png "Ginkgo emoji")                | `:ginkgoleaf:`   | Adds the `SGG::Ginkgo` label to the pairing issue     |
| ![Kapok emoji](https://handbook.gitlab.com/support/workflows/assets/pairify_kapok.png "Kapok emoji")                       | `:kapok:`        | Adds the `SGG::Kapok` label to the pairing issue      |
| ![Maple emoji](https://handbook.gitlab.com/support/workflows/assets/pairify_maple_leaf.png "Maple emoji")                  | `:maple_leaf:`   | Adds the `SGG::Maple` label to the pairing issue      |
| ![Pine emoji](https://handbook.gitlab.com/support/workflows/assets/pairify_pine.png "Pine emoji")                          | `:pine:`         | Adds the `SGG::Pine` label to the pairing issue       |
| ![Crush emoji](https://handbook.gitlab.com/support/workflows/assets/pairify_crush.png "Crush emoji")                       | `:crush:`        | Adds the `crush` label to the pairing issue           |
| ![Office hours emoji](https://handbook.gitlab.com/support/workflows/assets/pairify_office-hours.png "Office hours emoji")  | `:office-hours:` | Adds the `office hours` label to the pairing issue  |
