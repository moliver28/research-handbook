...
A vendor may not be available in Bitsight. A Company Request should be made [within BitSight](https://help.bitsighttech.com/hc/en-us/articles/231344488-Company-Requests) by the assesor. If the Company Request cannot fulfilled, validate that periodic penetration tests occur for the vendor and reference the pen test activity in place of a BitSight report.
