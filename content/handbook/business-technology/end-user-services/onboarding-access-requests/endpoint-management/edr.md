...
5. After some time a report will finish and you will see another notifation from SentinelOne that a log file was completed. Click the notification and you may be required to allow the SentinelAgent access to files on your Desktop folder. The file will then download to your Desktop folder.
...
6. Analyze the data that the report generates, and if needed share the file with #sentinelone and we will get a ticket open with SentinelOne support.
