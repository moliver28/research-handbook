...
Here's a diagram illustrating this point:
![image](/uploads/2f835f0283c692a4a8ca084262b3577b/image.png)
...
Source: https://stackoverflow.com/a/28404036
...
We will calculate percentage improvement in runtime using the traditional formula:
```
(new - old)/old*100%
```

So if the old runtime was 10 seconds, and the new runtime is 15 seconds then:
```
(new - old)/old*100%
=(15-10)/10*100%
=-50%
...
We have discussed the theory of what the 'optimal' warehouse is

1. run an `explain` plan to figure out how many partitions the table has
2. Based on the number of partitions, use this diagram to estimate what warehouse to start with ![image](/uploads/dae7f8c2497352101e1b2d0b9965ca7e/image.png)
...
- [select.dev](https://select.dev/posts/snowflake-warehouse-sizing)
- calculating percentage improvements for runtimes, [StackOverflow](https://stackoverflow.com/a/28404036)
