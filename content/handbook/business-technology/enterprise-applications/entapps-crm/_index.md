...
Label: `entapps-status::deployed-0`
...
Label: `entapps-status::deployed-1`
...
Label: `entapps-status::deployed-2`
...
Label: `entapps-status::deployed-3`
...
3. The Systems Label Workflow and Label Description are as follows
      ...
      ![The CRM Systems Label Workflow](/handbook/business-technology/crm-labels.png)

      - ![entapps CRM systems](/handbook/business-technology/entapps-crm-systems.png) New Issues that are created in the EntApps CRM board are automatically tagged and any existing issues related to sales systems are tagged with this label
      - ![entapps waiting](/handbook/business-technology/entapps-waiting.png) Issues awaiting for information from the requester, needs more clarity in requirements may or may not be assigned to milestone and assigned to the DRI and/or systems team member
      - ![entapps out of scope](/handbook/business-technology/entapps-out-of-scope.png) Issues that are outside the parameters of an initiative, cannot be combined with current functionality and this issue will be closed
      - ![entapps inbox](/handbook/business-technology/entapps-inbox.png) Issues that are new and have not been evaluated yet
      - ![entapps assigned](/handbook/business-technology/entapps-assigned.png) Issues that are ready to moveforward to be worked on, slotted to a milestone & assigned to systems team member's queue
      - ![entapps build](/handbook/business-technology/entapps-build.png) Issues that are in the current milestone, assigned to systems team member that are actively worked on
      - ![Rentapps customer review](/handbook/business-technology/entapps-customer-review.png) Issues in current milestone that are near the finish line, needs to be reviewed and demoed to the business owner(s) to sign-off
      - ![entapps ready to deploy](/handbook/business-technology/entapps-deploy.png) Issues in current milestones, sign-offs given by the business owner that are ready to be deployed by systems team member
      - ![entapps blocked](/handbook/business-technology/entapps-blocked.png) Issues in the current milestone which are assigned to systems team member which are stalled due to technical difficulties and/or assigned to business owner pending to provide information to the systems member to move forward
...
- entapps-status::deployed-0
- entapps-status::deployed-1
- entapps-status::deployed-2
- entapps-status::deployed-3

**[Systems DRI] Screenshot of Completed Change Set Attached and MR Attached (if Code) :- If the issue ended up in label `entapps-status::deployed-2` OR `entapps-status::deployed-3` the systems member assigned to the issue should add the screenshot of the change set**
